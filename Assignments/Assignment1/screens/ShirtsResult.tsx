...
const ShirtsResult = ({navigation}) => {
    ...
    const products = [
        {
            id: 1,
            name: "Purple Formal Women Shirt",
            price: 30,
            stock: 8,
            imageUrl: require('../assets/Shirt1.jpeg'),
        },
        {
            id: 2,
            name: "White Casual Women Shirt",
            price: 12,
            stock: 7,
            imageUrl: require('../assets/Shirt2.jpg'),
        },
        {
            id: 3,
            name: "Blue Denim Shirt For Men",
            price: 39,
            stock: 4,
            imageUrl: require('../assets/Shirt3.jpeg'),
        },
        {
            id: 4,
            name: "Men Orange Printed Shirt",
            price: 69,
            stock: 15,
            imageUrl: require('../assets/Shirt4.jpeg'),
        },
        {
            id: 5,
            name: "Denim Shirt For Women",
            price: 29,
            stock: 3,
            imageUrl: require('../assets/Shirt5.jpeg'),
        },
        {
            id: 6,
            ...
            price: 15,
            stock: 2,
            imageUrl: require('../assets/Shirt6.jpeg'),
        },
    ];
