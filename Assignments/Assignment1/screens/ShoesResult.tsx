...
const ShoesResult = ({navigation}) => {
    ...
    const products = [
        {
            id: 1,
            name: "Nike Red Walking Shoes",
            price: 120,
            stock: 3,
            imageUrl: require('../assets/Shoe1.jpeg'),
        },
        {
            id: 2,
            name: "Nike Blue and White Shoes",
            price: 150,
            stock: 8,
            imageUrl: require('../assets/Shoe2.webp'),
        },
        {
            id: 3,
            ...
            price: 240,
            stock: 10,
            imageUrl: require('../assets/Shoe3.webp'),
        },
        {
            id: 4,
            name: "Pink Heels",
            price: 70,
            stock: 6,
            imageUrl: require('../assets/Shoe4.jpeg'),
        },
        {
            id: 5,
            ...
            price: 129,
            stock: 8,
            imageUrl: require('../assets/Shoe5.jpeg'),
        },
        {
            id: 6,
            name: "Ombre Summer Flipflops",
            price: 15,
            stock: 2,
            imageUrl: require('../assets/Shoe6.jpeg'),
        },
    ];
