...
const GymWearResult = ({navigation}) => {
    ...
    const gymWearProducts = [
        {
            id: 1,
            name: "Black Round Neck Gym T-Shirt",
            price: 30,
            stock: 6,
            imageUrl: require('../assets/GymWear1.webp'),
        },
        {
            id: 2,
            ...
            price: 69,
            stock: 8,
            imageUrl: require('../assets/GymWear2.webp'),
        },
        {
            id: 3,
            name: "Colourful Tank Tops - Set of 6",
            price: 40,
            stock: 4,
            imageUrl: require('../assets/GymWear3.jpeg'),
        },
        {
            id: 4,
            name: "Black Gym Sweatpants",
            price: 20,
            stock: 12,
            imageUrl: require('../assets/GymWear4.jpg'),
        },
        {
            id: 5,
            ...
            price: 79,
            stock: 9,
            imageUrl: require('../assets/GymWear6.webp'),
        },
        {
            id: 6,
            name: "Black and Grey Full Sleeve T-shirt",
            price: 24,
            stock: 2,
            imageUrl: require('../assets/GymWear6.webp'),
        },
